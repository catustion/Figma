...
import { Column, Stack, Row, Text, Line, Img, Input, Button } from "components";
      ...
      <Column className="bg-gray_100 font-ptsans items-center justify-start mx-[auto] lg:pb-[41px] xl:pb-[51px] 2xl:pb-[58px] 3xl:pb-[69px] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="justify-start mt-[1px] w-[100%]">
                ...
                <Column className="items-center justify-start w-[100%]">
                  <Row className="items-start w-[47%]">
                    <Column className="items-center justify-start mt-[2px] w-[33%]">
                      <Column className="items-center justify-start w-[100%]">
                        <Text
                          className="font-normal text-gray_501 w-[auto]"
                          variant="body2"
                        >
                          Property setup
                        </Text>
                    ...
                    <Text className="Photos2" variant="body2">
                      Photos
                    </Text>
                    <Text className="Pricingandcal2" variant="body2">
            ...
            <Text className="columnnameandlocati" as="h5" variant="h5">
              Breakfast details
            </Text>
            <Column className="font-ptsans items-center justify-start xl:ml-[110px] 2xl:ml-[124px] 3xl:ml-[148px] lg:ml-[88px] lg:mt-[26px] xl:mt-[32px] 2xl:mt-[37px] 3xl:mt-[44px] w-[39%]">
              <Column className="bg-white_A700 justify-end lg:p-[13px] xl:p-[16px] 2xl:p-[19px] 3xl:p-[22px] shadow-bs3 w-[100%]">
                <Column className="justify-start ml-[2px] 3xl:mt-[10px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[35%]">
                  <Text
                ...
                <Text
                  className="font-bold ml-[2px] lg:mt-[26px] xl:mt-[32px] 2xl:mt-[37px] 3xl:mt-[44px] text-black_900 w-[auto]"
                  as="h6"
                  variant="h6"
                >
                ...
                <Img
                  ...
                  className="lg:h-[16px] xl:h-[20px] 2xl:h-[23px] 3xl:h-[27px] ml-[2px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[29%]"
                  alt="Radio Two"
                />
                <Img
                  src="images/img_radio_2.png"
                  className="lg:h-[16px] xl:h-[20px] 2xl:h-[23px] 3xl:h-[27px] ml-[2px] w-[29%]"
                  alt="Radio Three"
                />
                <Text
                  className="ml-[2px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] Box1"
                  variant="body2"
                >
                  Breakfast price per person, per day
                </Text>
                <Column className="font-ptsanscaption justify-start ml-[2px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[96%]">
                  <Input
                    className="font-normal p-[0] lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] placeholder:text-gray_501 text-gray_501 w-[100%]"
                    wrapClassName="w-[100%]"
                    name="price"
                    placeholder="MYR"
                    size="sm"
                  ...
                  ></Input>
                  <Text className="Myr" variant="body4">
                    Including all fees and taxes
                  </Text>
                </Column>
                <Line className="bg-gray_700_33 h-[1.5px] ml-[2px] lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[96%]" />
                <Column className="items-center justify-start ml-[2px] lg:mt-[22px] xl:mt-[27px] 2xl:mt-[31px] 3xl:mt-[37px] rounded-radius501 w-[88%]">
