...
const PricingandcalendarFivePage = () => {
  ...
  return (
    <>
      <Column className="bg-gray_50 font-ptsans items-center justify-start mx-[auto] lg:pb-[136px] xl:pb-[170px] 2xl:pb-[192px] 3xl:pb-[230px] w-[100%]">
            ...
            <Row className="items-start lg:mt-[51px] xl:mt-[64px] 2xl:mt-[73px] 3xl:mt-[87px] w-[87%]">
              <Column className="items-center justify-start w-[68%]">
                ...
                <Column className="items-center justify-start lg:mt-[33px] xl:mt-[41px] 2xl:mt-[47px] 3xl:mt-[56px] w-[99%]">
                  ...
                  <Footer1
                    className="lg:mt-[35px] xl:mt-[44px] 2xl:mt-[50px] 3xl:mt-[60px] w-[100%]"
                    onstackexpandarrowClick={handleNavigate89}
                  />
                </Column>
              </Column>
